      ...
      <div class="nav-container">
        ...
        <div class="nav-right">
          <button class="icon-button theme-toggle" @click="toggleTheme" :title="isDark ? 'Light Mode' : 'Dark Mode'">
            <svg v-if="isDark" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2">
            ...
            <svg v-else width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="grey" stroke-width="2">
